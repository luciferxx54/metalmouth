...
mm_OSEM.tagNameFilterFunctions['SPAN'] = function(currentNode) {
	...
	if ((parentTagname == "BODY")||(mm_OSEM.tagNameFilterFunctions.hasOwnProperty(parentTagname) == false)) { 
        // last condition checks if parentElement is unsupported - removed ||(parentTagname == "DIV")
